...
// FIXME keyboard controls are global for the entire window, not isolated to the specific game board
// FIXME generally speaking, the keyboard controls are greedy
