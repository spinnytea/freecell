...
export const SEED_SOLUTIONS_4x8 = new Map<number, string>([
	...
	[
		42,
		'' + // flourish
			'15 8a 81 8b 82 b8 28 21 ' +
			'68 65 67 2b 2c 24 27 58 ' +
			'57 45 67 17 62 1d 12 14 ' +
			'3h 32 c2 d3 85 46 41 42 ' +
			'46 41 34 63 32 23 78 74 ' +
			'b4 78 a8 71 71 56 53 54',
	],
	[
		617,
		'' + //
	...
	[
		6893,
		'' + //
			'82 85 32 3d 35 32 38 72 ' +
			'73 dh 4h 3h 41 54 63 68 ' +
			'65 35 23 56 58 85 87 48 ' +
			'42 14 1d 73 d7 13 61 12',
	],
	[
		23190,
		'' + // 52-card flourish
